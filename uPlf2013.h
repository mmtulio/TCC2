...
#define NUM_SALA 13 //10	      //total de salas disponíveis
#define NUM_TIPO_SALA 2    //total de tipos de salas
#define NUM_HORARIO 14     //horarios disponiveis da sala
#define NUM_TURMA 22 //14      //quantidade de turmas
#define NUM_OFERTA 93//80      //quantidade de ofertas de disciplinas
#define NUM_BLOQ 21 //13        //quantidade de ofertas de bloqueadas
#define NUM_DISCIPLINA 55 //72  //quantidade de disciplinas
#define NUM_DIA 5 		   //total de dias da semana
#define NUM_MAX_CANDIDATOS 910 //700 //é o valor de combinações possíveis de dias X horas X salas
#define ALFA 1          //valor alfa utilizado para fazer o corte na lista de candidatos
...
#define ARQ_OFERTAS "arquivos/ofertas.txt"
#define ARQ_DISCP "arquivos/disciplinas.txt"
#define ARQ_TURMAS "arquivos/turmas.txt"
#define ARQ_LOCAIS "arquivos/locais.txt"
#define ARQ_TIPOS "arquivos/tipos.txt"
#define ARQ_HORARIOS "arquivos/horarios.txt"
#define ARQ_PROFS "arquivos/professores.txt"
#define ARQ_HORSALA "arquivos/horarioSala/"
